...
export default function SelectBoxField() {
  return (
    <>
      ...
      <h2 className="heading2">최종대학계열<em>*</em></h2>
      <div className="cell_group">
        <span className="cell_box">
          <span className="cell_select1">
            <select name="" id="">
      ...
      <br />
      <h2 className="heading2">환불 은행명<em>*</em></h2>
      <div className="cell_group">
        <span className="cell_box">
          <span className="cell_select1">
            <select id="cboRefundBank" name="cboRefundBank"><option value=""> :: 선택 :: </option>
